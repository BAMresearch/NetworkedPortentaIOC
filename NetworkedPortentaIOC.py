...
class PortentaIOC(PVGroup):
    ...
    do0 = pvproperty(value=0, name="do0", doc="Digital output 0, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')   
    do1 = pvproperty(value=0, name="do1", doc="Digital output 1, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')
    do2 = pvproperty(value=0, name="do2", doc="Digital output 2, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')
    do3 = pvproperty(value=0, name="do3", doc="Digital output 3, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')
    do4 = pvproperty(value=0, name="do4", doc="Digital output 4, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')
    do5 = pvproperty(value=0, name="do5", doc="Digital output 5, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')
    do6 = pvproperty(value=0, name="do6", doc="Digital output 6, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')
    do7 = pvproperty(value=0, name="do7", doc="Digital output 7, can be 'Low' or 'High'", enum_strings=['Low', 'High'], dtype=ChannelType.ENUM, record='bo')
    @do0.putter
