...
class PortentaIOC(PVGroup):
    ...
    do0 = pvproperty(name="do0", doc="Digital output 0, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')   
    do1 = pvproperty(name="do1", doc="Digital output 1, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do2 = pvproperty(name="do2", doc="Digital output 2, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do3 = pvproperty(name="do3", doc="Digital output 3, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do4 = pvproperty(name="do4", doc="Digital output 4, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do5 = pvproperty(name="do5", doc="Digital output 5, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do6 = pvproperty(name="do6", doc="Digital output 6, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do7 = pvproperty(name="do7", doc="Digital output 7, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do0_RBV = pvproperty(name="do0_RBV", doc="Digital output 0 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')   
    do1_RBV = pvproperty(name="do1_RBV", doc="Digital output 1 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do2_RBV = pvproperty(name="do2_RBV", doc="Digital output 2 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do3_RBV = pvproperty(name="do3_RBV", doc="Digital output 3 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do4_RBV = pvproperty(name="do4_RBV", doc="Digital output 4 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do5_RBV = pvproperty(name="do5_RBV", doc="Digital output 5 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do6_RBV = pvproperty(name="do6_RBV", doc="Digital output 6 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
    do7_RBV = pvproperty(name="do7_RBV", doc="Digital output 7 readback value, can be 0 or 1", enum_strings=['Low', 'High'], dtype=bool, record='bo')
