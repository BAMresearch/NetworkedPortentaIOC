...
class PortentaIOC(PVGroup):
    ...
    @do0.scan(period=15, use_scan_field=True)
    ...
    @do1.scan(period=15, use_scan_field=True)
    ...
    @do2.scan(period=15, use_scan_field=True)
    ...
    @do3.scan(period=15, use_scan_field=True)
    ...
    @do4.scan(period=15, use_scan_field=True)
    ...
    @do5.scan(period=15, use_scan_field=True)
    ...
    @do6.scan(period=15, use_scan_field=True)
    ...
    @do7.scan(period=15, use_scan_field=True)
    ...
    @dio0.scan(period=15, use_scan_field=True)
    ...
    @dio1.scan(period=15, use_scan_field=True)
    ...
    @dio2.scan(period=15, use_scan_field=True)
    ...
    @dio3.scan(period=15, use_scan_field=True)
    ...
    @dio4.scan(period=15, use_scan_field=True)
    ...
    @dio5.scan(period=15, use_scan_field=True)
    ...
    @dio6.scan(period=15, use_scan_field=True)
    ...
    @dio7.scan(period=15, use_scan_field=True)
    ...
    @di0.scan(period=15, use_scan_field=True)
    ...
    @di1.scan(period=15, use_scan_field=True)
    ...
    @di2.scan(period=15, use_scan_field=True)
    ...
    @di3.scan(period=15, use_scan_field=True)
    ...
    @di4.scan(period=15, use_scan_field=True)
    ...
    @di5.scan(period=15, use_scan_field=True)
    ...
    @di6.scan(period=15, use_scan_field=True)
    ...
    @di7.scan(period=15, use_scan_field=True)
    ...
    @ao0.scan(period=15, use_scan_field=True)
    ...
    @ao1.scan(period=15, use_scan_field=True)
    ...
    @ao2.scan(period=15, use_scan_field=True)
    ...
    @ao3.scan(period=15, use_scan_field=True)
    ...
    @ai0.scan(period=15, use_scan_field=True)
    ...
    @ai1.scan(period=15, use_scan_field=True)
    ...
    @ai2.scan(period=15, use_scan_field=True)
    async def ai2(self, instance: ChannelData, async_lib: AsyncLibraryLayer):
        async with self._communication_lock:
            await self.ai2.write(self.client.read("AI", 2))

    ai3 = pvproperty(name="ai3", doc="Analog input 3, can be 0-10V", dtype=float, record='ao')
    @ai3.scan(period=15, use_scan_field=True)
    async def ai3(self, instance: ChannelData, async_lib: AsyncLibraryLayer):
        async with self._communication_lock:
            await self.ai3.write(self.client.read("AI", 3))


    t0 = pvproperty(name="t0", doc="Temperature sensor 0 (degrees C)", dtype=float, record='ao')
    @t0.scan(period=15, use_scan_field=True)
    ...
    @t1.scan(period=15, use_scan_field=True)
    ...
    @t2.scan(period=15, use_scan_field=True)
